...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // if this page doesn't have assignment elements, exit safely
    if (!titleInput || !courseInput || !createBtn) return;
    ...
    courseInput.addEventListener("input", toggleCreateButton);
});
